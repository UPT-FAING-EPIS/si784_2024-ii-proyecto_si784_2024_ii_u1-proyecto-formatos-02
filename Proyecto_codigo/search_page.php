...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      ...
      $message[] = '¡Producto añadido al carrito!'; /*hace conexion con los valores y cantddad de productos en mysqli*/
   }
...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search" placeholder="buscar productos..." class="box"> <!--cuadro de busqueda-->
