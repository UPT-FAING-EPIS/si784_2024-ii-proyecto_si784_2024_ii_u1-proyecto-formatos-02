...
if(isset($_POST['add_product'])){
   ...
   /*apodemos agregar pelis ya a la tienda con imagen desde mysqli*/
...
if(isset($_GET['delete'])){ /*eliminar pelis */
...
if(isset($_POST['update_product'])){ /*mod btn of edit update and delte - deja modificar pelis img,price*/
 ...
 /*mmodifica el cartel de entrada**/
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         $message[] = 'image file size is too large'; /*tamaño de mensaje de imagen permit*/
      }else{
